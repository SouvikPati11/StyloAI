...
import { IsBoolean, IsIn, IsInt, IsOptional, IsString, IsNotEmpty } from 'class-validator';
...
const SECTIONS = Object.values(ContentSection);

class TrendingDto {
  @IsIn(SECTIONS) section!: ContentSection;
